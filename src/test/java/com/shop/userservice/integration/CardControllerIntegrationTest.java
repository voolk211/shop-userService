...
import com.shop.userservice.model.patchdto.CardPatchDto;
...
public class CardControllerIntegrationTest extends AbstractIntegrationTest {
    ...
    void shouldCreateCard() throws Exception {
        UserDto user = createUser("card@test.com", 1L);
    ...
    void shouldGetCardById() throws Exception {
        UserDto user = createUser("getcard@test.com", 2L);
    ...
    void shouldUpdateCard() throws Exception {
        UserDto user = createUser("updatecard@test.com", 3L);
    ...
    void updateShouldReturn400_whenIdMismatch() throws Exception {
        UserDto user = createUser("mismatch@test.com", 4L);
    ...
    void shouldPatchCard() throws Exception {
        UserDto user = createUser("patchcard@test.com", 5L);
    ...
    void shouldDeleteCard() throws Exception {
        UserDto user = createUser("deletecard@test.com", 9L);
